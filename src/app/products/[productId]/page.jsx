...
const ProductPage = async ({ params }) => {
  ...
  return (
    <>
      <Header />
      <div className="text-black w-4/5 m-auto pt-8 overflow-hidden">
        <p className="text-6xl animatedText">{product.title}</p>
        <div className="bg-white flex flex-col align-start pt-16 pb-8 gap-8 justify-around md:flex-row md:px-16 fadeInUp">
          ...
          <div className="text-black flex flex-col gap-8 border p-8">
            <p>BRAND</p>
            <p className="text-stone-700 max-w-80 italic">
              {product.description}
            </p>
            <p className="flex">
              {product.rating.rate}
                ...
                <AccordionTrigger>
                  <span className="flex justify-start gap-4">
                    ...
                    >
                      <g opacity="0.5">
                        <path
                          d="M13.5654 7.22473H18.0525L22.4874 11.6074V18.338H20.4914"
                          stroke="black"
                        />
